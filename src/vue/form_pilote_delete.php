    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 text-center mb-5">
                <h1 class="heading-section">SUPRESSION</h1>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="login-wrap p-0">
                    <form action="../traitement/traitement_pilote_delete.php" method="post" class="signin-form">
                        ...
                        <div class="form-group">
                            <button type="submit" class="form-control btn btn-light submit px-3">Supprimer</button>
                        </div>
                </div>
                </form>
            </div>
