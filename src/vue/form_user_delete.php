                ...
                <div class="login-wrap p-0">
                    <form action="../traitement/traitement_user_delete.php" method="post" class="signin-form">
                        <div class="form-group">
                            <input type="text" readonly="readonly" name="id_user" class="form-control"
                                   value=<?php echo $_SESSION['id_user']; ?>>
                        </div>
                        <div class="form-group">
                            <button onClick="return confirm('Etes vous sur de vouloir supprimer votre compte?')" type="submit" class="form-control btn btn-light submit px-3">Supprimer</button>
                        </div>
                </div>
                </form>
            </div>
