        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-2">
                    ...
                    <br>
                    <br>
                    <h1 class="heading-section">OH NON, VOUS PARTEZ DÉJÀ? </h1>
                    <p style="color: white"><b>Nous somme triste de vous voir partir</b></p>
                </div>
            </div>
            <br>
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <div class="form-group">
                            <button onclick="location.href='../../index.php';" class="form-control btn btn-light submit px-3">Revenir à la page d'accueil</button>
                        </div>
                    </div>
                    </form>
                </div>
